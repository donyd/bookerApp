...
class ReadersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reader" do
    assert_difference('Reader.count') do
      post readers_url, params: { reader: { email: @reader.email, firstname: @reader.firstname, lastname: @reader.lastname } }
    end
  ...
  test "should update reader" do
    patch reader_url(@reader), params: { reader: { email: @reader.email, firstname: @reader.firstname, lastname: @reader.lastname } }
